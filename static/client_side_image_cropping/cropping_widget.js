...
$(document).ready(function($) {
    ...
    $('.dcsic_wrapper').addClass('text-center');
    ...
    $(".dcsic_ok").click(function(e) {
        window.dcsic_cropobj.croppie('result', {
            ...
            window.dcsic_wrapper.find(".dcsic_current_img").addClass('img-fluid-custom');
            window.dcsic_wrapper.find(".dcsic_current_img").removeAttr('style');
            close_dialog();
